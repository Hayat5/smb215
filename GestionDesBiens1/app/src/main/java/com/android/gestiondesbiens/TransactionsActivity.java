        ...
        try{
            ...
            for(int i = 0; i < this.transactionsList.size(); i++){
             this.mapReservedWorkDetails = new HashMap<String, String>();
                 ...
                 this.mapReservedWorkDetails.put("ItemCode", this.transactionsList.get(i).getItemCode());
                 this.mapReservedWorkDetails.put("ItemName", this.transactionsList.get(i).getItemName());
                 this.mapReservedWorkDetails.put("ItemSpecification", this.transactionsList.get(i).getItemSpecification());
                 this.mapReservedWorkDetails.put("TypeName", this.transactionsList.get(i).getTypeName());
                 this.mapReservedWorkDetails.put("ItemDateCreated", this.transactionsList.get(i).getItemDateCreated());
                 this.mapReservedWorkDetails.put("CenterName", this.transactionsList.get(i).getCenterSrcName());
                 this.mapReservedWorkDetails.put("SalleName", this.transactionsList.get(i).getSalleSrcName());
                 this.mapReservedWorkDetails.put("PersonnelName", this.transactionsList.get(i).getPersonnelSrcName());
